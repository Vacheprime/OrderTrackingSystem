            ...
            <div id="orders-side-content" class="side-content">
                <div class="side-content-container">
                    ...
                    <div class="side-content-scrollable">
                        ...
                        <p><b>Product Description:</b><x-area-input-property name="detail-product-description" labelText="Product Description" :isLabel="false" :readonly="true"/></p>
                        <p><b>Product Notes:</b><x-area-input-property name="detail-product-notes" labelText="Product Notes" :isLabel="false" :readonly="true"/></p>
                    </div>
                </div>
