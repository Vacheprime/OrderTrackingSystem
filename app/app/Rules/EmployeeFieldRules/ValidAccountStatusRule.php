...
class ValidAccountStatusRule extends BaseValidationRule
{
    /**
    ...
    protected function getErrorMessages(string $attribute): array {
        return [
            "$attribute.required" => "The account status is required.",
            "$attribute.string" => "The account status must be a string.",
        ];
    }
}
